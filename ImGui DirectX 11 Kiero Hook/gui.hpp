...
struct c_color {
    int r, g, b, a;
    c_color(int r = 255, int g = 255, int b = 255, int a = 255) : r(r), g(g), b(b), a(a) {}
    int convert() const { return (a << 24) | (b << 16) | (g << 8) | r; }
};
...
public:
    ...
    vector < const char* > rage_subtabs = { "CS:2 Early Access" };
    vector < const char* > rage_subtabs1 = { "Credits" };
    vector < const char* > rage_subtabs2 = { "Settings" };
